...
public class spin180 {
    static DcMotor backleftMotor, backrightMotor, frontrightMotor, frontleftMotor;
    static BNO055IMU imu;
    static Orientation lastAngles = new Orientation();
    static double                  globalAngle;
    public static void init180spin(DcMotor BLM, DcMotor BRM, DcMotor FRM, DcMotor FLM){
        backleftMotor =BLM;
        backrightMotor = BRM;
        frontrightMotor = FRM;
        frontleftMotor = FLM;
